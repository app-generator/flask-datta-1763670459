...
class Task(db.Model):
    ...
    lame = db.Column(db.String(255),  nullable=True)
    email = db.Column(db.String(255),  nullable=True)
    week_name = db.Column(db.String(255),  nullable=True)
    task_date = db.Column(db.DateTime, default=db.func.current_timestamp())
